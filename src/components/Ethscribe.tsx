...
function templateMin(message:string) {
  ...
  <style>*{box-sizing:border-box}body{font-family:monospace;background-color:#f0f0f0;color:#333;margin:0;padding:0}#container{width:100%;max-width:600px;margin:auto;text-align:center;padding:16px}#content{padding:20px;background:#fff;border-radius:10px;box-shadow:0 0 10px rgba(0,0,0,.1)}#password{width:100%;padding:10px;font-size:16px;border:1px solid #aaa;border-radius:4px;font-family:monospace}#decrypted-content,#encrypted-content{white-space:pre-wrap;margin:1em 0;text-align:left;font-size:14px;transition:opacity .5s ease;opacity:1;overflow-wrap:break-word}@keyframes fadeIn{from{opacity:0}to{opacity:1}}.fade-in{animation:fadeIn .25s ease-in-out}pre.fade-out{opacity:0}</style>
  </head>
  <body>
  <div id=container>
  <div id=content>
